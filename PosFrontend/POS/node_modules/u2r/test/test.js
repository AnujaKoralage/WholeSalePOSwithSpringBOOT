...
test.exe(function() {
  var url = "http://no.de.jp.js.dot.net.dot.com/manage-customer.html.tpl.js.css.img?q=a&ab=wefwef";
  var r = u2r(url);
  test('equal', r.host, 'no.de.jp.js.dot.net.dot.com', url + ': wrong host');
  test('equal', r.path, '/manage-customer.html.tpl.js.css.img?q=a&ab=wefwef', url + ': wrong path');
  test('equal', r.port, '80', url + ': wrong port');
  test('equal', r.protocol, 'http', url + ': wrong protocol');
  test('result', url, true);
});
